...
for i in range(len(clf)):
    ...
    for j in range(mc):
        ...
        clfCVS = {'dataName': 2015, 'classifier': clf[i].name, 'percent': score/float(omniScore),'score': score,'OmniScore': omniScore, 'Type1-A/A/Good': typeNum1, 'Type2-A/B/Bad': typeNum2, 'Type3-A/B/Good': typeNum3, 'Type4-A/A/Bad': typeNum4}
        o.writerow(clfCVS)
